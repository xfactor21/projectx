...
import { readWorkspaceActivity, recordWorkspaceActivity, refreshWorkspaceActivity, WORKSPACE_ACTIVITY_EVENT } from './services/workspaceActivity'
...
export default function WorkspaceAppV3(){
  ...
  function deleteProject(project:Project){
    ...
    recordWorkspaceActivity({projectId:project.id,type:'project.record.deleted',message:`${project.name} removed from project.X.`});deleteProjectAndLocalSource(project.id);setSelected(null);setStatus(`${project.name} was removed from project.X. Local files were not deleted.`)
  }
