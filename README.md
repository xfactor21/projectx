...
Release packaging produces separate archives: `projectX_8-27_v2.2-source.zip` contains the committed project tree under one top-level folder, while `projectX_8-27_v2.2-windows.zip` contains only the Windows installer.
